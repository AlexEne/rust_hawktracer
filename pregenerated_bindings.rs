...
pub const HT_VERSION: &'static [u8; 6usize] = b"0.7.0\0";
pub const HT_VERSION_MAJOR: u32 = 0;
pub const HT_VERSION_MINOR: u32 = 7;
...
pub const HT_FEATURE_CACHED_STRING: u32 = 1;
pub const HT_FEATURE_CALLSTACK: u32 = 0;
...
pub const HT_ErrorCode_HT_ERR_LISTENER_CONTAINER_ALREADY_REGISTERED: HT_ErrorCode = 4;
/// Cannot open file.
pub const HT_ErrorCode_HT_ERR_CANT_OPEN_FILE: HT_ErrorCode = 5;
...
pub const HT_ErrorCode_HT_ERR_CANT_START_TCP_SERVER: HT_ErrorCode = 6;
/// Unable to create listener container. This is most likely caused by
/// #HT_ERR_OUT_OF_MEMORY occured internally in the library.
pub const HT_ErrorCode_HT_ERR_CANT_CREATE_LISTENER_CONTAINER: HT_ErrorCode = 7;
/// Format of an input data is invalid.
pub const HT_ErrorCode_HT_ERR_INVALID_FORMAT: HT_ErrorCode = 8;
/// Invalid argument
pub const HT_ErrorCode_HT_ERR_INVALID_ARGUMENT: HT_ErrorCode = 9;
...
extern "C" {
    pub fn ht_timeline_listener_container_create() -> *mut HT_TimelineListenerContainer;
}
extern "C" {
    ...
    pub fn ht_timeline_listener_container_register_listener(
        container: *mut HT_TimelineListenerContainer,
        callback: HT_TimelineListenerCallback,
        user_data: *mut ::std::os::raw::c_void,
    ) -> HT_ErrorCode;
}
extern "C" {
    ...
    ///
    /// @param container a pointer to the container.
    pub fn ht_timeline_listener_container_unregister_all_listeners(
        container: *mut HT_TimelineListenerContainer,
    );
}
extern "C" {
    ...
    pub fn ht_find_or_create_listener(
...
extern "C" {
    ...
    ///
    /// @returns #HT_ERR_OK, if registration completed successfully; otherwise, appropriate error code.
    pub fn ht_registry_register_feature(
        feature_id: u32,
...
extern "C" {
    pub fn ht_feature_cached_string_enable(timeline: *mut HT_Timeline) -> HT_ErrorCode;
}
extern "C" {
...
extern "C" {
    pub fn ht_system_info_push_endianness_info_to_listener(
        callback: HT_TimelineListenerCallback,
        listener: *mut ::std::os::raw::c_void,
        serialize: HT_Boolean,
    ) -> usize;
...
extern "C" {
    pub fn ht_system_info_push_system_info_to_listener(
        callback: HT_TimelineListenerCallback,
        listener: *mut ::std::os::raw::c_void,
        serialize: HT_Boolean,
    ) -> usize;
